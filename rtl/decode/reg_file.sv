module reg_file (
        ...
        input logic        i_rst_n,
        input logic        i_clk,          // Vẫn dùng Clock hệ thống
        ...
        //------------------------- Read (Modified with Internal Forwarding) -----
        // Logic: Nếu (Đang Ghi) VÀ (Địa chỉ Ghi == Địa chỉ Đọc) -> Lấy luôn Data đang ghi
        // Ngược lại -> Lấy Data từ mảng nhớ như bình thường
